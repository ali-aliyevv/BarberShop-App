...
const Home: React.FC = () => {
  return (
    <>
      {/* Altdakı ağ boşluğu tamamilə aradan qaldıran sabit arxa plan */}
      <div className="fixed inset-0 bg-gray-900 -z-10" />

      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-72px)] text-white px-4 py-12">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="text-center p-8 md:p-12 bg-black/40 rounded-3xl border border-white/10 shadow-2xl backdrop-blur-md max-w-3xl w-full relative z-10"
        >
          ...
          <p className="text-base md:text-xl text-gray-300 mb-8 max-w-xl mx-auto leading-relaxed">
            Deluxe səviyyəli xidmət və mükəmməl tərziniz üçün doğru
            ünvandasınız. Peşəkar ustalarımızla ən son dəblə saç və saqqal
            kəsimi xidmətləri təqdim edirik.
          </p>
          <Link
            to="/services"
